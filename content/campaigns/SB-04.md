...
| Enterprise | T1567.002 | Exfiltration Over Web Service: Exfiltration to Cloud Storage | 캠페인 당시 공격 그룹은 내부 RDS 고객 데이터를 HTTPS POST 요청으로 외부 웹 수신지에 유출했다. | [[AL-003]],[[FL-007]]|

...
| T1611 Escape to Host | 컨테이너 이미지와 namespace를 확인하여 일반 업무 Pod가 아니라 공격 목적으로 생성된 Pod 또는 특권 Pod에서 발생한 이벤트인지 식별한다. | `container_image_repository`, `container_image_tag`, `k8s_ns_name` |

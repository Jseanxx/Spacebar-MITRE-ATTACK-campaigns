...
| Collection | Filebeat custom input 또는 PostgreSQL module |
...
| ELK | 후속 확장: Filebeat custom input 또는 PostgreSQL module로 수집 |
| 조회 감사 | 후속 확장: 짧은 검증 시간 동안 `log_statement='all'` 또는 pgaudit 적용 |
